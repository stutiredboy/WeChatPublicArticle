...
![CPU、GPU、TPU 的架构与设计取舍](images/cpu-gpu-tpu-architecture.png)
...
![AI Infra 的数据路径与互连层级](images/ai-infra-data-path.png)
...
![Roofline 模型：以 H100 为例](images/roofline-model.png)
...
![GPU 栈与 TPU 栈对照](images/software-stacks.png)
...
![传统可插拔光模块与 CPO 的结构差异](images/pluggable-vs-cpo.png)
